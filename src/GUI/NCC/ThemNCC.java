...
public class ThemNCC extends javax.swing.JFrame {
    ...
    public ThemNCC(NhaCungCap nhaCungCap) {
        initComponents();
        initAtt(nhaCungCap);
    ...
    private void initComponents() {
        ...
        pnlTopLayout.setHorizontalGroup(
            ...
            .addComponent(lblTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 504, Short.MAX_VALUE)
        );
    ...
    private void btnThemKHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemKHActionPerformed
        ...
        NhaCungCapDTO nhaCungCapDTO = new NhaCungCapDTO(id, name, phoneNumber, email);
        int code = nhaCungCapBUS.addNCC(nhaCungCapDTO);

        if (code == 1) {
            // nhaCungCapGUI.updateTable(nhaCungCapDTO, 1);
    ...
    private void initAtt(NhaCungCap nhaCungCap) {
